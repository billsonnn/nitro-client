...
export class MainComponent implements OnInit, OnDestroy, AfterContentInit, ILinkEventTracker
{
    ...
    public ngOnInit(): void
    {
        this._ngZone.runOutsideAngular(() =>
        {
            ...
            if(Nitro.instance.roomSessionManager.events)
            {
                ...
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_KICKED, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_PETS_FORBIDDEN_IN_HOTEL, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_PETS_FORBIDDEN_IN_FLAT, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_MAX_PETS, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_MAX_NUMBER_OF_OWN_PETS, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_NO_FREE_TILES_FOR_PET, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_SELECTED_TILE_NOT_FREE_FOR_PET, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_BOTS_FORBIDDEN_IN_HOTEL, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_BOTS_FORBIDDEN_IN_FLAT, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_BOT_LIMIT_REACHED, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_SELECTED_TILE_NOT_FREE_FOR_BOT, this._Str_4868);
                Nitro.instance.roomSessionManager.events.addEventListener(RoomSessionErrorMessageEvent.RSEME_BOT_NAME_NOT_ACCEPTED, this._Str_4868);
            }
        });
    }
    ...
    public ngOnDestroy(): void
    {
        this._ngZone.runOutsideAngular(() =>
        {
            ...
            if(Nitro.instance.roomSessionManager.events)
            {
                ...
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_KICKED, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_PETS_FORBIDDEN_IN_HOTEL, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_PETS_FORBIDDEN_IN_FLAT, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_MAX_PETS, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_MAX_NUMBER_OF_OWN_PETS, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_NO_FREE_TILES_FOR_PET, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_SELECTED_TILE_NOT_FREE_FOR_PET, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_BOTS_FORBIDDEN_IN_HOTEL, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_BOTS_FORBIDDEN_IN_FLAT, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_BOT_LIMIT_REACHED, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_SELECTED_TILE_NOT_FREE_FOR_BOT, this._Str_4868);
                Nitro.instance.roomSessionManager.events.removeEventListener(RoomSessionErrorMessageEvent.RSEME_BOT_NAME_NOT_ACCEPTED, this._Str_4868);
            }
        });
    ...
    private _Str_4868(event: RoomSessionEvent):void
    {
        if(!event) return;
