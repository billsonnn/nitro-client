...
import { EventDispatcher } from '@nitrots/nitro-renderer/src/core/events/EventDispatcher';
import { IEventDispatcher } from '@nitrots/nitro-renderer/src/core/events/IEventDispatcher';
import { AcceptFriendResultEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/AcceptFriendResultEvent';
import { FindFriendsProcessResultEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FindFriendsProcessResultEvent';
import { FollowFriendFailedEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FollowFriendFailedEvent';
import { FriendListFragmentEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendListFragmentEvent';
import { FriendListUpdateEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendListUpdateEvent';
import { FriendNotificationEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendNotificationEvent';
import { FriendParser } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendParser';
import { FriendRequestData } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendRequestData';
import { FriendRequestsEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendRequestsEvent';
import { HabboSearchResultEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/HabboSearchResultEvent';
import { InstantMessageErrorEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/InstantMessageErrorEvent';
import { MessageErrorEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MessageErrorEvent';
import { MessengerInitEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MessengerInitEvent';
import { MiniMailNewMessageEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MiniMailNewMessageEvent';
import { MiniMailUnreadCountEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MiniMailUnreadCountEvent';
import { NewConsoleMessageEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/NewConsoleMessageEvent';
import { NewFriendRequestEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/NewFriendRequestEvent';
import { RoomInviteErrorEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/RoomInviteErrorEvent';
import { RoomInviteEvent } from '@nitrots/nitro-renderer/src/nitro/communication/messages/incoming/friendlist/RoomInviteEvent';
import { AcceptFriendComposer } from '@nitrots/nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/AcceptFriendComposer';
import { DeclineFriendComposer } from '@nitrots/nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/DeclineFriendComposer';
import { GetFriendRequestsComposer } from '@nitrots/nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/GetFriendRequestsComposer';
import { RequestFriendComposer } from '@nitrots/nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/RequestFriendComposer';
