...
import { AcceptFriendResultEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/AcceptFriendResultEvent';
import { FindFriendsProcessResultEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FindFriendsProcessResultEvent';
import { FollowFriendFailedEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FollowFriendFailedEvent';
import { FriendListFragmentEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendListFragmentEvent';
import { FriendListUpdateEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendListUpdateEvent';
import { FriendNotificationEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendNotificationEvent';
import { FriendParser } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendParser';
import { FriendRequestData } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendRequestData';
import { FriendRequestsEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/FriendRequestsEvent';
import { HabboSearchResultEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/HabboSearchResultEvent';
import { InstantMessageErrorEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/InstantMessageErrorEvent';
import { MessageErrorEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MessageErrorEvent';
import { MessengerInitEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MessengerInitEvent';
import { MiniMailNewMessageEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MiniMailNewMessageEvent';
import { MiniMailUnreadCountEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/MiniMailUnreadCountEvent';
import { NewConsoleMessageEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/NewConsoleMessageEvent';
import { NewFriendRequestEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/NewFriendRequestEvent';
import { RoomInviteErrorEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/RoomInviteErrorEvent';
import { RoomInviteEvent } from 'nitro-renderer/src/nitro/communication/messages/incoming/friendlist/RoomInviteEvent';
import { AcceptFriendComposer } from 'nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/AcceptFriendComposer';
import { DeclineFriendComposer } from 'nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/DeclineFriendComposer';
import { GetFriendRequestsComposer } from 'nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/GetFriendRequestsComposer';
import { RequestFriendComposer } from 'nitro-renderer/src/nitro/communication/messages/outgoing/friendlist/RequestFriendComposer';
